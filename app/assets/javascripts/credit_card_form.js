...
$(document).ready(function() {
  ...
  // function to handle submit of the form and intercept the default event
  ...
  // Initiate submit handler listener fro any form with class cc_form
  ...
  // function to handle the token reveiced from Stripe and remove credit card fields
